...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    (function setHeaderAnimations() {
        ...
        scroll > headerHeight ? header.classList.add("--scroll") : header.classList.remove("--scroll");
        window.addEventListener("scroll", (event)=>{
            scroll = pageYOffset;
            if (!header.classList.contains("--feedback") && !header.classList.contains("--menu")) {
                if (scroll > 0) previousScroll < scroll ? header.classList.add("--hide") : header.classList.remove("--hide");
        ...
        if (!document.querySelector(".header") && !document.querySelector(".header__form") && !document.querySelector(".hero__offset")) return;
        const header = document.querySelector(".header");
        ...
        triggers.forEach((trigger)=>{
            trigger.addEventListener("click", (event)=>{
                ...
                !header.classList.contains("--menu") ? header.classList.add("--menu") : header.classList.remove("--menu");
            });
        });
        ...
        triggers.forEach((trigger)=>{
            trigger.addEventListener("click", (event)=>{
                ...
                } else header.classList.remove("--feedback");
            });
        });
        ...
        function setTitle(width) {
            width < 576 ? requestTitle.textContent = "\u0417\u0430\u044F\u0432\u043A\u0430" : requestTitle.textContent = "\u041F\u0440\u0435\u0434\u0432\u0430\u0440\u0438\u0442\u0435\u043B\u044C\u043D\u0430\u044F \u0437\u0430\u044F\u0432\u043A\u0430";
        }
    }(), function forms() {
        const forms = [
        ...
        forms.forEach((form)=>{
            ...
            form.addEventListener("submit", (event)=>{
                ...
                if (check) {
                    ...
                    form.reset();
                    const elements = [
                        ...form.querySelectorAll(".form__elementToHide")
                    ];
        ...
        const slider = new (0, _swiperDefault.default)(block, {
            modules: [
        ...
        triggers.forEach((trigger)=>{
            ...
            if (href !== "#") trigger.addEventListener("click", (event)=>{
                event.preventDefault();
        ...
        if (!document.querySelector(".blog__item") && document.querySelectorAll(".blog__item").length !== 3) return;
        let screen = window.innerWidth;
        const section = document.querySelector(".blog .container");
        let sectionWidth = section.getBoundingClientRect().width;
        const items = [
            ...section.querySelectorAll(".blog__item")
        ];
        ...
        const values = [
            ...section.querySelectorAll(".prices__value")
        ];
        window.addEventListener("scroll", ()=>{
            ...
            if (params.pixelHeight !== null && positionPixel < scroll) setValues();
            let positionBlock = scroll + top - (screenHeight - params.blockHeight);
            if (params.blockHeight !== null && positionBlock < scroll) setValues();
            let positionScreen = scroll + top - screenHeight * params.screenHeight;
            if (params.screenHeight !== null && positionScreen < scroll) setValues();
        });
        function setValues() {
            let start = 100;
